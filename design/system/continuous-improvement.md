...
`summary.md` is a table of open issues: ID, class, title, count, cost, last reported. It is regenerated by `flai issue` (S-027); until then it is maintained by hand with every occurrence.
