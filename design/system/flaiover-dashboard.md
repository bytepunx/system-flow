...
- **`/mcp`** still exists in this release and answers 503, because there is no flai in the image for its bridge to start. S-0076 gives MCP over HTTP to flai on the host and removes the route.
