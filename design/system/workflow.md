...
[ADR-0046](../adrs/0046-a-ready-story-whose-claim-overlaps-an-open-story-s-is-held-yellow-and-with-its.md) (S-0124) turns `touches` into a claim that scheduling acts on: a ready story whose claim overlaps an open story's, or that names an unfinished story in `after:`, is held, yellow and with its reason, and later ready stories that overlap nothing go ahead of it. Trial merges at `flai stream sync` and a notice at acceptance catch what the claims miss. The stories under E-0009 build it; until they are accepted the paragraph above is how flai behaves. The survey behind it is [agent-coordination.md](agent-coordination.md).
