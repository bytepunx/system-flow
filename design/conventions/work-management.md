...
- Do not ask the operator to place stories in the pull order: the board gives them no way to change it until S-0057. Pull the story they name, or the first ready one; if an order change matters, make it in `board.md` yourself and say so.
