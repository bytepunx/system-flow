...
| Git | 2.47 (host), 2.54 (image); 2.38 or newer for the trial merge at sync, 2.48 or newer only for the opt-in relative worktree links | flai, flaiover image | [git.md](git.md) |
