...
## Acceptance criteria
- [ ] template/root/CLAUDE.md.tmpl opens with a "Prime your session" section: read conventions/README.md and every file it lists in order, then wip/agents/index.md, then the board, before any change
...
- [ ] Baseline CLAUDE.md shrinks: layout table, priming section, pointers; the norms themselves are in conventions/
