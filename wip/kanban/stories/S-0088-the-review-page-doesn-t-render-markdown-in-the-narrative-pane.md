...
All markdown in the site should be correctly rendered. The narrative pane on the review page is not rendering markdown.

## Acceptance criteria
- [ ] The narrative pane correctly shows rendered markdown
