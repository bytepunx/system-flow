...
- [ ] Project additions here say how flai and flaiover apply them (flai: structured stderr logging and a --verbose flag; flaiover: request logs, health endpoint, metrics endpoint) and open follow-up stories where code must change
- [ ] design/tech records any logging or telemetry library the conventions imply, with version and rationale, or states that the standard library suffices
- [ ] flai check --strict passes in this repository and on a rendered template
