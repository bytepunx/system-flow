...
- T-0056 Project additions, follow-up stories, design/tech, mirror here

## Notes
- Rules drafted; the first three criteria (status active, README suffix) wait for the operator to confirm the text.
- Created 2026-09-16 at the operator's request after S-0025 found the two empty placeholder files. The agent proposes the rules; the operator edits or confirms before they leave draft.
