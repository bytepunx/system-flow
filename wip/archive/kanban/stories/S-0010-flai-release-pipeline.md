...
## Tasks
- T-0030 GoReleaser config with version injection
- T-0031 Release workflow on flai/v* tags
- T-0032 Snapshot build verification and install docs
- T-0046 gh repository creation and release bump rules in git.md
