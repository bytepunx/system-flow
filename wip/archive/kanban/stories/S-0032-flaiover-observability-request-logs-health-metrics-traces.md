...
## Tasks
- T-0101 pino logging: request line with trace_id, lifecycle events, LOG_LEVEL and LOG_FORMAT
- T-0102 /_health, /_ready with dependency checks, /metrics with prom-client golden signals and build_info
- T-0103 OpenTelemetry traces via OTLP when configured, W3C context propagation, one span per request
- T-0104 compose stack with a collector and viewer; operator docs; tech pins; tests

## Notes
- Created by S-0030. Depends on S-0011 (dashboard scaffold). Nature feature; bump flaiover minor on acceptance.
