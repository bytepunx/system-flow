...
- [x] Image runs as an arbitrary non-root UID (flai dashboard passes `--user uid:gid`; verified in S-0009 that an image needing root or a fixed user exits at once) and serves on 3000
...
- T-0099 Local image script and Makefile target; run it with flai dashboard end to end
- T-0100 release-flaiover workflow: GHCR tags latest, semver, major, sha; docs
