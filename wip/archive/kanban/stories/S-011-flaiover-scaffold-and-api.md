...
- T-083 Repo reader: manifest, items, docs tree and file, with a mtime cache and a watcher emitting SSE
- T-084 API routes /api/manifest, /api/items, /api/items/:id, /api/docs/tree, /api/docs/file, /api/events with tests
- T-085 Scripts, Makefile, CI workflow for flaiover; design and tech docs
