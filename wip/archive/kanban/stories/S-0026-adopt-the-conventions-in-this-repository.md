...
- T-0041 ADR-0014 design/issues and continuous-improvement design
- T-0042 Copy conventions into design/conventions with project additions
- T-0043 Seed design/issues and add scripts/ with Makefile delegation
- T-0044 Align CLAUDE.md, layout docs, and current practice
- T-0045 Apply operator answers: test tiers, commit timing, kluster
...
- Blocked until the operator has finished editing the template conventions; pull only when asked. If S-0023 is done and the operator has not asked, skip to S-0024.
