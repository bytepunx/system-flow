...
- [x] The topic list is agreed with the operator before S-0023 starts (confirmed 2026-09-15)

## Tasks
- T-0033 ADR-0013 conventions folder
- T-0034 design/system/conventions.md living document
- T-0035 Update layout, manifest, template, and documentation standard docs
