...
- `design/issues/` skeleton and `scripts/` with test tier stubs and Makefile delegation (S-026).
- `CLAUDE.md` opens with a priming section and is a map; norms live in the conventions (S-024).
