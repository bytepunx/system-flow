...
- Commit when a story lands: when it moves to `review`, and again after the operator accepts and archives it. Use conventional commit style. Always report commits in the chat.
